...
import models.entities.Notificador.Medios.AdapterWhatsapp;
...
public class testWhatsapp {
    ...
    public void testNotificar() {
        // Act
        adapterWhatsapp.notificar(notificacion);

        // Assert
        ArgumentCaptor<Notificacion> argumentCaptor = ArgumentCaptor.forClass(Notificacion.class);
        verify(adapterWhatsapp).notificar(argumentCaptor.capture());
